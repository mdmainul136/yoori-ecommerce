...
use App\Http\Controllers\Admin\Addons\StoreManagerController;
    ...
    Route::group(
        ...
        function () {
            Route::prefix('admin')->group(function () {
                Route::get('store-manager/preference', [StoreManagerController::class, 'preference'])->name('admin.store.manager.preference');
                Route::get('store-manager/seller-contact', [StoreManagerController::class, 'sellerContact'])->name('admin.store.manager.contacts');
                Route::post('store-manager/settings/update', [StoreManagerController::class, 'update'])->name('admin.store-manager.setting.update');
