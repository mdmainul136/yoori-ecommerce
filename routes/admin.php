...
Route::get('admin/migrate-new/table', [GeneralSettingsController::class, 'migrateNewTable'])->name('admin.migrate.new-table');
    ...
    Route::group(
        ...
        Route::middleware(['adminCheck','loginCheck'])->group(function () {
            ...
            Route::prefix('admin')->group(function () {
                ...
                Route::put('sliders/update/{slider_id}', [SliderController::class, 'update'])->name('sliders.update')->middleware('PermissionCheck:slider_update');
                ...
                // Marquee routes...
                Route::get('marquees', [MarqueeController::class, 'index'])->name('marquees');
                ...
                Route::put('marquees/update', [MarqueeController::class, 'update'])->name('marquees.update');
                Route::put('marquee-status-change', [MarqueeController::class, 'statusChange'])->name('marquees.status.change');
                Route::delete('delete/marquees/{marquee}', [CommonController::class, 'delete']);
