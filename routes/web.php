...
//            Route::get('coupon-lists', [UserController::class, 'couponList'])->name('convert.reward.history');
    ...
    Route::get('home/category-wise/subcategory/{slug}', [FrontendController::class, 'subcategories'])->name('front.subcategories');
    ...
    Route::get('home/get-category/breadcrumb/{slug}', [ProductController::class, 'breadcrumbSlug'])->name('breadcrumbSlug');
    Route::get('home/get-title/breadcrumb/{slug}/{routeName}', [ProductController::class, 'breadcrumbTitle'])->name('breadcrumbTitle');
    ...
    Route::post('razorpay/payment-verify', [PaymentController::class, 'razorpayPaymentVerify'])->name('razorpay.paymentVerify');

    // Wallet Razor payment
    Route::get('wallet-razorpay/redirect', [PaymentController::class, 'razorpayWalletRedirect'])->name('wallet.razorpay.redirect');
    Route::post('wallet-razorpay/payment-verify', [PaymentController::class, 'razorpayWalletPaymentVerify'])->name('wallet.razorpay.paymentVerify');
