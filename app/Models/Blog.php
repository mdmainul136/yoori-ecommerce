...
class Blog extends Model
{
    ...
    {
        return @is_file_exists($this->image['image_385x260'] , $this->image['storage']) ? @get_media($this->image['image_385x260'],$this->image['storage']) : static_asset('images/default/385x260.png');
    }

    public function getRecentPostImageAttribute()
    {
        return @is_file_exists($this->image['image_385x260'] , $this->image['storage']) ? @get_media($this->image['image_385x260'],$this->image['storage']) : static_asset('images/default/120X80.png');
    }

    public function getBannerImgAttribute()
    {
        return @is_file_exists($this->banner['image_853x446'] , $this->banner['storage']) ? @get_media($this->banner['image_853x446'],$this->banner['storage']) : static_asset('images/default/853x446.png');
    }
