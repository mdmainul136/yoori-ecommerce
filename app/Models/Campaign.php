...
class Campaign extends Model
{
    ...
    protected $appends = ['image_1920x412','image_406x235','image_375x220','short_description','campaign_start_date','campaign_end_date',];
    protected $casts = [
        'banner' => 'array',
        'thumbnail' => 'array'
    ];
    ...
    public function getImage375x220Attribute()
    {
        // return $this->thumbnail;
        return @is_file_exists($this->thumbnail['image_750x260'] , $this->thumbnail['storage']) ? @get_media($this->thumbnail['image_750x260'],$this->thumbnail['storage']) : static_asset('images/default/campaign-750X260.png');
    }
