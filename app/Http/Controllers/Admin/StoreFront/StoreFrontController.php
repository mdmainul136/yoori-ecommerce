        ...
        try {
            if ($request->user_dashboard_banner) {
                ...
                $images[$key] = [
                    ...
                    'images' => $this->getImageWithRecommendedSize($request->user_dashboard_banner, '1320', '105')
                ];
            }
            ...
            if ($request->category_default_banner) {
                ...
                $images[$key] = [
                    ...
                    'images' => $this->getImageWithRecommendedSize($request->category_default_banner, '970', '270', true)
                ];
            }
            ...
            if ($request->seller_sing_up_banner) {
                ...
                $images[$key] = [
                    ...
                    'images' => $this->getImageWithRecommendedSize($request->seller_sing_up_banner, '652', '852', true)
                ];
            }
            if ($request->affiliate_sing_up_banner) {
                ...
                $images[$key] = [
                    ...
                    'images' => $this->getImageWithRecommendedSize($request->affiliate_sing_up_banner, '652', '852', true)
                ];
            }
            ...
            foreach ($all_images as $key => $banner):
                $images[$key] = [
                    'id' => $banner,
                    'images' => $this->getImageWithRecommendedSize($banner, '652', '677')
                ];
            endforeach;
