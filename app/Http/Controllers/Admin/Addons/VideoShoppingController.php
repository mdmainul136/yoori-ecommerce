...
class VideoShoppingController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('admin.video-shopping.index',compact('videos'));
    }
    public function store(VideoShoppingRequest $request){
        if ($this->videoShopping->store($request)):
            Toastr::success(__('Created Successfully'));
            return redirect()->route('admin.video.shopping');
        else:
     ...
     public function edit($id, Request $request){
         try {
             ...
             if ($video_language = $this->videoShopping->getByLang($id, $lang)) :
                 ...
                 return view('admin.video-shopping.edit', compact('video_language', 'languages', 'lang', 'r','products','product_ids'));
             else:
    ...
    public function videoShoppingConfig(){
        return view('admin.video-shopping.video-shopping-config');
    }
}
