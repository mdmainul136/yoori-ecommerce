...
class HomeController extends Controller
{
    ...
    public function index(
        ...
        try {
            ...
            $product_sold = settingHelper('sold') ? settingHelper('sold') : 0;
            ...
            $data = [
                ...
                // 'marquees' => MarqueeResource::collection($marquee->frontendMarquees()),
    ...
    public function settingsData($page): array
    {
        ...
        $settings = [
            ...
            'dark_logo' => !empty(settingHelper('dark_logo')) && is_array(settingHelper('dark_logo'))
            ? (
                !empty(settingHelper('dark_logo')['original_image']) && @is_file_exists(settingHelper('dark_logo')['original_image'])
                    ? get_media(settingHelper('dark_logo')['original_image'], settingHelper('dark_logo')['storage'])
                    : (
                        !empty(settingHelper('dark_logo')['original_image']) && @is_file_exists(settingHelper('dark_logo')['original_image'])
                            ? get_media(settingHelper('dark_logo')['original_image'], settingHelper('dark_logo')['storage'])
                            : static_asset('images/default/dark-logo.png')
                    )
            )
            : static_asset('images/default/dark-logo.png'),


            // 20250812114944_original_dark_logo10


            'demo_logo' => static_asset('images/default/logo.svg'),
            ...
            'login_banner' => @getFileLink('652x677', settingHelper('login_banner')['images']),
            ...
            'sign_up_banner' => @getFileLink('652x677', settingHelper('sing_up_banner')['images']),
            'affiliate_sing_up_banner' => @getFileLink('652x677', settingHelper('affiliate_sing_up_banner')['images']),
            'seller_sing_up_banner' => @getFileLink('652x852', settingHelper('seller_sing_up_banner')['images']),
            'forgot_password_banner' => @getFileLink('652x677', settingHelper('forgot_password_banner')['images']),
            'user_dashboard_banner' => @getFileLink('1320x105', settingHelper('user_dashboard_banner')['images']),
