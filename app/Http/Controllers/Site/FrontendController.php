...
class FrontendController extends Controller
{
    ...
    public function home(
        ...
        Request $request): \Illuminate\Http\JsonResponse
    {
        try {
    ...
    public function subcategories($slug, CategoryInterface $category): \Illuminate\Http\JsonResponse
    {
        try {
            $data = [
                'subcategories' => CategoryResource::collection($category->subcategoryPage($slug))
            ];
            return response()->json($data);
        } catch (\Exception $e) {
            return response()->json([
