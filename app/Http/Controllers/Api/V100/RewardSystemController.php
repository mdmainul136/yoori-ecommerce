...
class RewardSystemController extends Controller
{
    ...
    public function myReward(Request $request, RewardSystemInterface $reward): \Illuminate\Http\JsonResponse
    {
        try {
            ...
            return $this->responseWithError(__('Token has expired'), [], 401);
        } catch (\Exception $e) {
            return $this->responseWithError(__('Token is invalid'), [], 401);
        } catch (\Exception $e) {
            return $this->responseWithError(__('Token not provided'), [], 401);
        } catch (\Exception $e) {
