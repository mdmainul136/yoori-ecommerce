...
class PageRepository implements PageInterface
{
            ...
            foreach ($request->contents as $key => $content):
                ...
                if ($content == 'banner'):
                    ...
                    foreach ($request->$banner_thumbnail as $url_key => $thumbnail):
                        ...
                        $this->getImageArrayRecommendedSize($thumbnail, [650], [301]);

                        $url = $request->$banner_url[$url_key];
                        $home_page_contents[$key]['banner']['thumbnail'][] = $thumbnail;
                        $home_page_contents[$key]['banner']['url'][] = $url;
                    endforeach;
                ...
                elseif ($content == 'offer_ending_soon'):
                    $banner = $requested_content . '_banner';
                    $banner_url = $requested_content . '_banner_url';
                    $this->getImageWithRecommendedSize($request->$banner, '516', '375', true);
                    ...
                    $banner_2 = $requested_content . '_banner_2';
                    $banner_url_2 = $requested_content . '_banner_url_2';
                    $this->getImageWithRecommendedSize($request->$banner_2, '516', '375', true);
                    $home_page_contents[$key]['offer_ending_soon']['banner_2'] = $request->$banner_2;
                    $home_page_contents[$key]['offer_ending_soon']['banner_url_2'] = $request->$banner_url_2;

                    unset($request[$banner_2]);
                    unset($request[$banner_url_2]);
                ...
                elseif ($content == 'download_section'):
                    ...
                    unset($request[$text]);
                elseif (
                    $content == 'campaign' || $content == 'popular_category' || $content == 'top_category' || $content == 'all_products' || $content == 'marquee_section' ||
    ...
    public function updateMobileHomeContent($request)
    {
        ...
        if ($request->contents):
            foreach ($request->contents as $key => $content):
                ...
                elseif ($content == 'download_section'):
                    ...
                    unset($request[$banner]);
                elseif (
                    $content == 'campaign' || $content == 'popular_category' || $content == 'top_category' ||
                    $content == 'best_selling_products' || $content == 'popular_brands' ||
                    $content == 'top_sellers' || $content == 'best_sellers' || $content == 'todays_deal' || $content == 'flash_deal' || $content == 'latest_news'
                    || $content == 'featured_sellers' || $content == 'express_sellers' || $content == 'latest_product' || $content == 'video_shopping' || $content == 'custom_products'
                ):
        ...
        $data->request->add(['mobile_subscription_section' => $request->has('mobile_subscription_section') ? 1 : 0]);
        $data->request->add(['mobile_service_info_section' => $request->has('mobile_service_info_section') ? 1 : 0]);
        $data->request->add(['mobile_recent_viewed_products' => $request->has('mobile_recent_viewed_products') ? 1 : 0]);
