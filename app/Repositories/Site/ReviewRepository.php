...
class ReviewRepository implements ReviewInterface
{
    ...
    public function getTxt(array $options)
    {
        // এখানে আপনি চাইলে কোন AI সার্ভিস দিয়ে রিয়েল রেসপন্স আনতে পারেন
        // আমি এখন demo হিসেবে একটা ডামি টেক্সট রিটার্ন করছি

        $prompt = $options['prompt'] ?? 'Thank you for your feedback. We value your opinion and will use it to improve.';
        $length = $options['length'] ?? 100;

        // ডামি টেক্সট (এখানে আপনি ChatGPT API ইত্যাদি ব্যবহার করতে পারেন)
        return Str::limit($prompt, $length);
    }
}
