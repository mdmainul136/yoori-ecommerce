<template>
    ...
    <div class="productlistItem">
        ...
        <div class="product-content">
            <div class="product-meta">
                ...
                <template v-if="productSold == 1">
                    <div class="product-status" v-if="product.sold > 0">
                        {{ lang.sold }} {{ product.sold }}
                    </div>
            ...
            <div class="rating-wrapper">
                <Rating :rating="product.rating" class="mb-2" /> ({{
        ...
        <div class="pricing-wrapper">
            ...
            <div class="product-actions mb-2" v-if="authUser">
                <a
                    class="action-btn wishlist"
                    v-if="$store.getters.isThisWishlisted(product.id)"
                    href="javaScript:void(0)"
