<template>
    ...
    <section
        ...
        v-if="gadget_product && lengthCounter(products) > 0"
    >
        <div class="container">
            <!-- Section Title Start -->
            <div class="row">
                    ...
                    <div class="section-title">
                        <div class="wrap">
                            <h2
                                class="title"
                                :class="{
                                    'title-bg': addons.includes('ishopet'),
                                }"
                            >
                                {{ category }}
                            </h2>
                        ...
                        <div class="section-btn">
                            <router-link
                                :to="{
                                    ...
                                    params: { slug: gadget_product.slug },
                                }"
                                class="solid-btn"
                                >{{ lang.more_products }}
                            </router-link>
    ...
    <section class="deals-section pt-60 pb-30" v-else-if="show_shimmer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="product-wrapper position-relative"></div>
                </div>
            </div>
        </div>
    </section>
