      ...
      <div class="row">
        <div class="col-12">
          <div class="section-title">
            <div class="wrap">
              <h2 class="title">
                {{ lang.top_categories_of_this_month }}
              </h2>
            </div>
            <div class="section-btn">
              <a
                :href="getUrl('categories')"
                @click.prevent="routerNavigator('categories', null)"
                class="solid-btn"
      ...
      <div class="row">
        <div class="col-12">
          <div class="categories-wrapper">
            <div class="row">
              <div v-for="(campaign, index) in 4" :key="index" class="col-md-3">
                <div class="categoriesItem p-3">
                  <a href="javascript:void(0)">
                    <shimmer class="mb-3" :height="200"></shimmer>
                  </a>
                </div>
              </div>
            </div>
