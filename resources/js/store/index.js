...
export default {
    ...
    actions: {
        ...
        product_sold(context, product_sold) {
            context.commit('getProductSold', product_sold)
        },
    ...
    mutations: {
        ...
        getProductSold(state, data){
            return state.product_sold = data;
        },
