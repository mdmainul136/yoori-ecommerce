<template>
    <div class="timer">
        <div class="time-box" v-for="(value, label) in time" :key="label">
            <p>{{ value }}</p>
            <span class="title" v-if="label == 'd'">Days</span>
            <span class="title" v-if="label == 'h'">Hrs</span>
            <span class="title" v-if="label == 'm'">Min</span>
            <span class="title" v-if="label == 's'">Sec</span>
        </div>
    </div>
