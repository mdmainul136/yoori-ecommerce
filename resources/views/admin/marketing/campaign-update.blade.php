                        ...
                        <form method="POST" action="{{ route('campaign.update') }}" enctype="multipart/form-data" id="campaign-create">
                            ...
                            <div class="form-group d-none">
                                ...
                                <div class="input-group colorpickerinput">
                                    <input type="text" class="form-control" name="background_color" value="{{ old('background_color') ? old('background_color') : $campaignByLang->campaign->background_color }}" id="background_color" placeholder="{{ __('Enter background color') }}">
                            ...
                            <div class="form-group d-none">
                                ...
                                <div class="input-group colorpickerinput">
                                    <input type="text" class="form-control" name="text_color" value="{{ old('text_color') ? old('text_color') : $campaignByLang->campaign->text_color }}" id="text_color" placeholder="{{ __('Enter campaign text color') }}">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <i class='bx bxs-color-fill' ></i>
                                        </div>
                            ...
                            <div class="form-group">
                                <label for="image">{{ __('Thumbnail') }} 750X260 </label>
                            ...
                            <div class="form-group">
                                <label for="image">{{ __('Banner') }} 1300X335</label>
                                <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                                     data-selection="single"
                                     data-target="#galleryModal" data-dismiss="modal">
