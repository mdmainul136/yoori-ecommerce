                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link bar {{ has_key(['price','special_discount_type','special_discount','special_discount_period','vat_taxes','has_variant','low_stock_to_notify','stock_visibility',
                                                    'sku','current_stock','colors','variant_sku.*', 'variant_stock.*' ],$errors) ? 'error' : '' }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2 filter-categories-by-ajax"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="thumbnail">{{ __('Thumbnail') }}(210X205)</label>
                                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @php
                                                        $selected_special_discount_type = old('special_discount_type') ?? optional($product_language->product)->special_discount_type;
                                                    @endphp

                                                    <select class="form-control selectric" name="special_discount_type" id="special_discount_type">
                                                        <option value="" {{ $selected_special_discount_type == '' ? 'selected' : '' }}>{{ __('Select Type') }}</option>
                                                        <option value="flat" {{ $selected_special_discount_type == 'flat' ? 'selected' : '' }}>{{ __('Flat') }}</option>
                                                        <option value="percentage" {{ $selected_special_discount_type == 'percentage' ? 'selected' : '' }}>{{ __('Percentage') }}</option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @php
                                                        $selected_discount_type = old('campaign_discount_type') ?? optional($product_language->productCampaign)->discount_type;
                                                    @endphp

                                                    <select class="form-control selectric" name="campaign_discount_type" id="campaign_discount_type">
                                                        <option value="" {{ $selected_discount_type == '' ? 'selected' : '' }}>{{ __('Select Discount Type') }}</option>
                                                        <option value="flat" {{ $selected_discount_type == 'flat' ? 'selected' : '' }}>{{ __('Flat') }}</option>
                                                        <option value="percent" {{ $selected_discount_type == 'percent' ? 'selected' : '' }}>{{ __('Percent') }}</option>
                                                    </select>
