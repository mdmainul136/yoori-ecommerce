...
@section('main-content')
    <section class="section">
        <div class="section-body">
            ...
            @php
                $all            = \App\Models\Product::withTrashed()->where('is_deleted',0)->UserCheck()->count();
                $total          = $all;
                $published      = \App\Models\Product::where('is_deleted',0)->UserCheck()->where('status','published')->where('is_approved', 1)->where('status','!=','trash')->count();
                $unpublished    = \App\Models\Product::where('is_deleted',0)->UserCheck()->where('status','unpublished')->where('is_approved', 1)->where('status','!=','trash')->count();
                $pending        = \App\Models\Product::where('is_deleted',0)->UserCheck()->where('is_approved', 0)->where('status','!=','trash')->count();
                $trash          = \App\Models\Product::withTrashed()->where('is_deleted',0)->UserCheck()->where('status','trash')->count();
