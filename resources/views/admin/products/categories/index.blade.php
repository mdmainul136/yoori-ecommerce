...
@section('main-content')
    <section class="section">
        <div class="section-body ">
            ...
            <div class="row">
                <div class="{{ hasPermission('category_create') ? 'col-sm-xs-12 col-md-8' : 'col-sm-xs-12 col-md-8 middle'}}">
                    <div class="card">
                        <form action="">
                                            ...
                                            <td>
                                                <label class="custom-switch mt-2 {{ hasPermission('category_update') ? '' : 'cursor-not-allowed' }}">
                                                    <input type="checkbox"
                                                           ...
                                                           {{$category->is_featured==1 ? 'checked' : ''}} {{ hasPermission('category_update') ? '' : 'disabled'}} name="custom-switch-checkbox"
                            ...
                            <div class="card-body card-body-paddding">
                                <form method="POST" action="{{route('store.categories')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control filter-categories-by-ajax lang" name="category">
                                            @if($old_category)
                                                <option value="{{ $old_category->id }}">{{ $old_category->getTranslation('title', App::getLocale()) }}</option>
                                            @endif
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label for="logo">{{ __('Banner') }} 970X270</label>
                                        <div class="form-group">
                                            <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                                                 data-selection="single"
                                                 data-target="#galleryModal" data-dismiss="modal">
