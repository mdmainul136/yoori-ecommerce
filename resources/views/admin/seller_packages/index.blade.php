                                ...
                                <div class="pricing-padding">
                                    ...
                                    <div class="pricing-details">
                                        ...
                                        <div class="pricing-item">
                                            @if(isset($active_package) && $active_package->seller_package_id == $package->id)
                                                @if($active_package->status == 1)
                                                    <p>{{ __('package_expire_at') }} :
                                                        <time datetime="{{ \Carbon\Carbon::parse($active_package->expires_at)->toDayDateTimeString('Y-m-d') }}">{{ \Carbon\Carbon::parse($active_package->expires_at)->toDayDateTimeString('Y-m-d') }}</time>
                                                    </p>
                                                @endif
                                            @endif
                                        </div>
