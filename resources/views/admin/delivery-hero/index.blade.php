                                        ...
                                        <td width="300">
                                            <div class="d-flex">
                                                <figure class="avatar mr-2">
                                                    <img src="{{ getFileLink('40x40', $value->images) }}"
                                                         alt="{{ $value->first_name }}" width="40">
                                                </figure>
                                                <div class="ml-1">
                                                    ...
                                                    {{ config('app.demo_mode') ? emailAddressMask($value->email) : $value->email }}
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{ config('app.demo_mode') ? Str::of($value->phone)->mask('*', 0, strlen($value->phone)-3) : $value->phone }}</td>
