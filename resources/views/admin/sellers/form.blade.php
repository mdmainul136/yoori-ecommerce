                    ...
                    <div class="col-sm-xs-12 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body card-body-paddding phone-block">
                                <div class="form-row">
                                    <div class="form-group mb-2 col-sm-xs-12 col-md-6">
                                ...
                                @if(addon_is_activated('ramdhani'))
                                    <div class="form-group mb-2">
                                        <label for="is_supplier">{{ __('Is Supplier') }} ?</label>
                                        <select name="is_supplier" id="is_supplier" class="form-control selectric">
                                            <option value="0" {{ isset($user) && $user->sellerProfile->is_supplier == 0 ? 'selected' : '' }}>{{ __('No') }}</option>
                                            <option value="1" {{ isset($user) && $user->sellerProfile->is_supplier == 1 ? 'selected' : '' }}>{{ __('Yes') }}</option>
                                        </select>
                                        @if ($errors->has('is_supplier'))
                                            <div class="invalid-feedback">
                                                <p>{{ $errors->first('is_supplier') }}</p>
                                            </div>
                                        @endif
                                    </div>
                                @endif
                    ...
                    <div class="col-sm-xs-12 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body card-body-paddding">
                                ...
                                <div class="form-group mb-2 seo-image-positoin">
