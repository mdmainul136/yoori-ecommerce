            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                <li class="nav-item ml-0 mb-2">
                                    <a class="nav-link {{  old('sms_method') == '' ? 'active' : '' }}" id="setting-tab"
                                       data-toggle="tab" href="#setting" role="tab"
                                       aria-controls="home"
                                       aria-selected="true">{{ __('Setting') }}</a>
                                </li>
                                <li class="nav-item ml-0 mb-2">
                                    <a class="nav-link {{  (old('sms_method') == 'twilio') ? 'active' : '' }}"
                                       id="twilio-tab" data-toggle="tab" href="#twilio" role="tab"
                                       aria-controls="home"
                                ...
                                <li class="nav-item ml-0 mb-2">
                                    <a class="nav-link {{ old('sms_method') == 'mimo_sms' ? 'active' : '' }}"
                                       id="mimo-tab" data-toggle="tab" href="#mimo" role="tab"
                                       aria-controls="contact"
                                       aria-selected="false">{{ __('MIMO') }}</a>
                                </li>
                                <li class="nav-item ml-0 mb-2">
                                    <a class="nav-link {{ old('sms_method') == 'nexmo_sms' ? 'active' : '' }}"
                                       id="nexmo-tab" data-toggle="tab" href="#nexmo" role="tab"
                                       aria-controls="profile"
                                       aria-selected="false">{{ __('Nexmo') }}</a>
                                </li>
                                <li class="nav-item ml-0 mb-2">
                                    <a class="nav-link {{ old('sms_method') == 'ssl_wireless' ? 'active' : '' }}"
                                       id="ssl-wireless-tab" data-toggle="tab" href="#ssl-wireless"
                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-9">
                    <div class="tab-content no-padding" id="myTab2Content">
                        ...
                        <div class="tab-pane fade {{ old('sms_method') == '' ? 'show active' : '' }}" id="setting"
                             role="tabpanel"
                            ...
                            <div class="card">
                                ...
                                <div class="col-md-12 middle card-body card-body-paddding">
                                    @if (hasPermission('otp_setting_update'))
                                        <form action="{{ route('admin.setting.otp.update') }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="active_sms_provider" class="form-control selectric"
                                                        id="active_sms_provider">
                        ...
                        <div class="tab-pane fade {{ old('sms_method') == 'fast_2' ? 'show active' : '' }}"
                            ...
                            <div class="card">
                                ...
                                <div class="form-group">
                                    @if(settingHelper('is_fast_2_activated') == 1)
                                        <a href="{{route('test.number','fast2')}}"
                                           class="btn btn-outline-primary currency-add-btn cache-btn "
                                           type="button">{{__('Test Number')}}</a>
                                    @endif
                                </div>
                                <div class="col-md-12 middle card-body card-body-paddding">
                                    <div class="form-group">
                                        <label class="custom-switch mt-2 {{ hasPermission('otp_setting_update') ? '' : 'cursor-not-allowed' }}">
                                            <input type="checkbox" name="custom-switch-checkbox"
                                                   value="sms-status-change/{{ 'is_fast_2_activated' }}"
                        ...
                        <div class="tab-pane fade {{ old('sms_method') == 'spagreen_sms' ? 'show active' : '' }}"
                            ...
                            <div class="card">
                                ...
                                <div class="form-group">
                                    @if(settingHelper('is_spagreen_sms_activated') == 1)
                                        <a href="{{route('test.number','spagreen')}}"
                                           class="btn btn-outline-primary currency-add-btn cache-btn "
                                           type="button">{{__('Test Number')}}</a>
                                    @endif
                                </div>
                                <div class="col-md-12 middle card-body card-body-paddding">
                                    ...
                                    @if(hasPermission('otp_setting_update'))
                                        <form action="{{ route('admin.setting.otp.update') }}" method="post"
                                            ...
                                            @endif
                                            <div class="form-group">
                                                <label for="spagreen_sms_api_key">{{ __('REVE Systems Api Key') }}
                                                    *</label>
                                                <input type="text" name="spagreen_sms_api_key" id="spagreen_sms_api_key"
                                                       value="{{ old('spagreen_sms_api_key') ? old('spagreen_sms_api_key') : settingHelper('spagreen_sms_api_key') }}"
                                                       placeholder="Wbla87d"
                                                       class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label for="spagreen_secret_key">{{ __('REVE Systems Secret') }}
                                                    *</label>
                                                <input type="text" name="spagreen_secret_key" id="spagreen_secret_key"
                                                       value="{{ old('spagreen_secret_key') ? old('spagreen_secret_key') : settingHelper('spagreen_secret_key') }}"
                                                       placeholder="A15di6"
                                                       class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label for="spagreen_secret_key">{{ __('REVE Systems Sender Id') }}
                                                    *</label>
                                                <input type="text" name="spagreen_sender_id" id="spagreen_sender_id"
                                                       value="{{ old('spagreen_sender_id', settingHelper('spagreen_sender_id'))  }}" class="form-control">
                                                @if ($errors->has('spagreen_sender_id'))
                                                    <div class="invalid-feedback">
                                                        {{ $errors->first('spagreen_sender_id') }}
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                <label for="spagreen_secret_key">{{ __('SMS URL') }}
                                                    *</label>
                                                <input type="text" name="spagreen_sms_url" id="spagreen_sms_url"
                                                       value="{{ old('spagreen_sms_url', settingHelper('spagreen_sms_url'))  }}" class="form-control">
                                                @if ($errors->has('spagreen_sms_url'))
                                                    <div class="invalid-feedback">
                                                        {{ $errors->first('spagreen_sms_url') }}
                                                    </div>
                                                @endif
                                            </div>
                                            @if(hasPermission('otp_setting_update'))
                        ...
                        <div class="tab-pane fade {{ old('sms_method') == 'mimo_sms' ? 'show active' : '' }}" id="mimo"
                             role="tabpane5"
                                    ...
                                    @if(hasPermission('otp_setting_update'))
                                        <form action="{{ route('admin.setting.otp.update') }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mimo_username" id="mimo_username"
                                                       value="{{ old('mimo_username') ? old('mimo_username') : settingHelper('mimo_username') }}"
                                                       placeholder="manik1010"
                                                       class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="mimo_sms_password" id="mimo_sms_password"
                                                       value="{{ old('mimo_sms_password') ? old('mimo_sms_password') : settingHelper('mimo_sms_password') }}"
                                                       placeholder="********"
                                                       class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mimo_sms_sender_id" id="mimo_sms_sender_id"
                                                       value="{{ old('mimo_sms_sender_id') ? old('mimo_sms_sender_id') : settingHelper('mimo_sms_sender_id') }}"
                                                       placeholder="B8h30"
                                                       class="form-control">
                        ...
                        <div class="tab-pane fade {{ old('sms_method') == 'nexmo_sms' ? 'show active' : '' }}"
                             id="nexmo" role="tabpane2"
                            ...
                            <div class="card">
                                ...
                                <div class="form-group">
                                    @if(!blank(settingHelper('is_nexmo_sms_activated')) && settingHelper('is_nexmo_sms_activated') == 1)
                                        <a href="{{ route('test.number','nexmo') }}"
                                           class="btn btn-outline-primary currency-add-btn cache-btn "
                                           type="button">{{__('Test Number')}}</a>
                                    @endif
                                </div>
                                    ...
                                    @if(hasPermission('otp_setting_update'))
                                        <form action="{{ route('admin.setting.otp.update') }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nexmo_sms_key" id="nexmo_sms_key"
                                                       value="{{ old('nexmo_sms_key') ? old('nexmo_sms_key') : settingHelper('nexmo_sms_key') }}"
                                                       placeholder="T9lkgfjds"
                                                       class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="nexmo_sms_secret_key"
                                                       id="nexmo_sms_secret_key"
                                                       value="{{ old('nexmo_sms_secret_key') ? old('nexmo_sms_secret_key') : settingHelper('nexmo_sms_secret_key') }}"
                                                       placeholder="Fb9532d"
                                                       class="form-control">
                        ...
                        <div class="tab-pane fade {{ old('sms_method') == 'twilio' ? 'show active' : '' }}" id="twilio"
                             role="tabpanel"
                            ...
                            <div class="card">
                                ...
                                @if(settingHelper('is_twilio_sms_activated') == 1)
                                    <a href="{{route('test.number','twilio')}}"
                                       class="btn btn-outline-primary currency-add-btn cache-btn "
                                       type="button">{{__('Test Number')}}</a>
                                @endif
                                <div class="col-md-12 middle card-body card-body-paddding">
                                    <div class="form-group">
                                        <label class="custom-switch {{ hasPermission('otp_setting_update') ? '' : 'cursor-not-allowed' }}">
                                            <input type="checkbox"
                                                   value="sms-status-change/{{ 'is_twilio_sms_activated' }}"
                                                   name="custom-switch-checkbox"
                                                   {{ hasPermission('otp_setting_update') ? '' : 'disabled' }}
                                    ...
                                    @if(hasPermission('otp_setting_update'))
                                        <form action="{{ route('admin.setting.otp.update') }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="twilio_sms_sid" id="twilio_sms_sid"
                                                       value="{{ old('twilio_sms_sid') ? old('twilio_sms_sid') : settingHelper('twilio_sms_sid') }}"
                                                       placeholder="Ylsdfoie"
                                                       class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label for="twilio_sms_auth_token">{{ __('Twilio Auth Token') }}
                                                    *</label>
                                                <input type="text" name="twilio_sms_auth_token"
                                                       id="twilio_sms_auth_token"
                                                       value="{{ old('twilio_sms_auth_token') ? old('twilio_sms_auth_token') : settingHelper('twilio_sms_auth_token') }}"
                                                       placeholder="OlOlsdfj"
                                                       class="form-control">
                                            ...
                                            {{--                                        </div>--}}
                                            <div class="form-group">
                                                <label for="valid_twilio_sms_number">{{ __('Valid Twilio Number') }}
                                                    *</label>
                                                <input type="text" name="valid_twilio_sms_number"
                                                       id="valid_twilio_sms_number"
                                                       value="{{ old('valid_twilio_sms_number') ? old('valid_twilio_sms_number') : settingHelper('valid_twilio_sms_number') }}"
                                                       placeholder="A30531014"
                                                       class="form-control">
                        ...
                        <div class="tab-pane fade {{ (old('sms_method') == 'ssl_wireless') ? 'show active' : '' }}"
                            ...
                            <div class="card">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        @if(settingHelper('is_ssl_wireless_sms_activated') == 1)
                                            <a href="{{route('test.number','ssl')}}"
                                               class="btn btn-outline-primary currency-add-btn cache-btn "
                                               type="button">{{__('Test Number')}}</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-12 middle card-body card-body-paddding tab-padding">
                                    <div class="form-group">
                                        <label class="custom-switch mt-2 {{ hasPermission('otp_setting_update') ? '' : 'cursor-not-allowed' }}">
                                            <input type="checkbox"
                                                   name="custom-switch-checkbox"
                                    ...
                                    @if(hasPermission('otp_setting_update'))
                                        <form action="{{ route('admin.setting.otp.update') }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ssl_sms_api_token" id="ssl_sms_api_token"
                                                       value="{{ old('ssl_sms_api_token') ? old('ssl_sms_api_token') : settingHelper('ssl_sms_api_token') }}"
                                                       placeholder="CDfawefCAFEAWf"
                                                       class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ssl_sms_sid" id="ssl_sms_sid"
                                                       value="{{ old('ssl_sms_sid') ? old('ssl_sms_sid') : settingHelper('ssl_sms_sid') }}"
                                                       placeholder="Djkd120"
                                                       class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ssm_sms_url" id="ssm_sms_url"
                                                       value="{{ old('ssm_sms_url') ? old('ssm_sms_url') : settingHelper('ssm_sms_url') }}"
                                                       placeholder="Jeiwrujfs"
                                                       class="form-control">
