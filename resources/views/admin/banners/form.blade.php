                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="sub_title" id="sub_title"
                                                value="{{ isset($edit) ? $edit->sub_title : old('sub_title') }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="btn_text" id="btn_text"
                                                value="{{ isset($edit) ? $edit->btn_text : old('btn_text') }}"
                                    ...
                                    <div class="form-group">
                                        <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                                            ...
                                            <input type="hidden" name="image"
                                                value="{{ isset($edit) ? $edit->image_id : '' }}" class="image-selected">
                                            <span class="form-control"><span
                                                    class="counter">{{ isset($edit) && $edit->image_id ? 1 : 0 }}</span>
                                                {{ __('file chosen') }}</span>
