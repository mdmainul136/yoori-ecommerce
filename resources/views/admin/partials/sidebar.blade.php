...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand sidebar-brand-sm">
            <a
                href="{{ route('dashboard') }}">{{ settingHelper('system_short_name') != '' ? settingHelper('system_short_name', app()->getLocale()) : 'Yoori' }}</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            {{-- stor manager menu --}}
            {{-- @if (addon_is_activated('store_manager')) --}}
                <li class="nav-item dropdown @yield('store_manager')">
                    <a href="javaScript:void(0)" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="bx bx-group {{ config('app.demo_mode') ? 'beep' : '' }}"></i>
                        <span>{{ __('Store Manager') }}</span>
                        @if (config('app.demo_mode'))
                            <p class="badge badge-addon">{{ __('Addon') }}</p>
                        @endif
                    </a>
                    <ul class="dropdown-menu">
                        <li class="@yield('preference')">
                            <a class="nav-link"
                                href="{{ route('admin.store.manager.preference') }}">{{ __('Preference') }}</a>
                        </li>
                        <li class="@yield('seller_contacts')">
                            <a class="nav-link"
                                href="{{ route('admin.store.manager.contacts') }}">{{ __('Seller Contacts') }}</a>
                        </li>
                    </ul>
                </li>
            {{-- @endif --}}
            ...
            @if (settingHelper('seller_system') == 1)
                ...
                @if (hasPermission('package_read') || hasPermission('subscription_setting_read'))
            ...
            @if (hasPermission('all_page_read'))
                <li class="nav-item dropdown @yield('pages_active')">
                    <a href="javaScript:void(0)" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="bx bx-paper-plane"></i>
                        <span>{{ __('Pages') }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="@yield('other_page')"><a class="nav-link"
                                href="{{ route('other.pages') }}">{{ __('Pages') }}</a>
                        </li>
                    </ul>
                </li>
            @endif
            ...
            @if (
                ...
                <li
                    ...
                    <ul class="dropdown-menu @yield('store-front')">
                        ...
                        <li class="@yield('marquee_active')">
                            <a class="nav-link" href="{{ route('marquees') }}"><span>{{ __('Marquee') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
