...
@endphp
    ...
    <link rel="stylesheet" href="{{ static_asset('frontends/css/materialdesignicons.min.css') }}">
    ...
    @if (request()->is('admin/pos'))
        <link rel="stylesheet" href="{{static_asset('frontends/css/vue-toastr-2.min.css')}}">
    @endif
