                                ...
                                <div id="awsDiv"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="aws_access_key_id" id="aws_access_key_id"
                                               value="{{ old('aws_access_key_id') ? old('aws_access_key_id') : (config('app.demo_mode') ? Str::of(settingHelper('aws_access_key_id'))->mask('*', 3, 15) : settingHelper('aws_access_key_id') ) }}"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="aws_secret_access_key" id="aws_access_key_id"
                                               value="{{ old('aws_secret_access_key') ? old('aws_secret_access_key') : (config('app.demo_mode') ? Str::of(settingHelper('aws_secret_access_key'))->mask('*', 3, 25) : settingHelper('aws_secret_access_key') ) }}"
                                ...
                                <div id="wasabiDiv"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="wasabi_access_key_id" id="wasabi_access_key_id"
                                               value="{{ old('wasabi_access_key_id') ? old('wasabi_access_key_id') : (config('app.demo_mode') ? Str::of(settingHelper('wasabi_access_key_id'))->mask('*', 3, 15) : settingHelper('wasabi_access_key_id') ) }}"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="wasabi_secret_access_key" id="wasabi_access_key_id"
                                               value="{{ old('wasabi_secret_access_key') ? old('wasabi_secret_access_key') : (config('app.demo_mode') ? Str::of(settingHelper('wasabi_secret_access_key'))->mask('*', 3, 25) : settingHelper('wasabi_secret_access_key') ) }}"
