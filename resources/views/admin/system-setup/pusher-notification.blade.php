                        ...
                        <div class="card-body col-md-12 middle">
                            ...
                            <form action="{{ route('third.party.setting.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="pusher_app_id" id="pusher_app_id" required value="{{ old('pusher_app_id') ? old('pusher_app_id') : (config('app.demo_mode') ? Str::of(settingHelper('pusher_app_id'))->mask('*', 3, 25) : settingHelper('pusher_app_id')) }}"  placeholder="{{ __('Pusher App ID') }}">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="pusher_app_key" id="pusher_app_key" required value="{{ old('pusher_app_key') ? old('pusher_app_key') : (config('app.demo_mode') ? Str::of(settingHelper('pusher_app_key'))->mask('*', 3, 25) : settingHelper('pusher_app_key')) }}"  placeholder="{{ __('Pusher App Key') }}">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="pusher_app_secret" id="pusher_app_secret" required value="{{ old('pusher_app_secret') ? old('pusher_app_secret') : (config('app.demo_mode') ? Str::of(settingHelper('pusher_app_secret'))->mask('*', 3, 25) : settingHelper('pusher_app_secret')) }}"  placeholder="{{ __('Pusher App Secret') }}">
