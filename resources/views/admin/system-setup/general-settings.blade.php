                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-2">
                                            ...
                                            {{-- @dd($icon) --}}
                                            <div>
                                                @if(@is_file_exists(getArrayValue('image_72x72_url', $icon)))
                                                    <img src="{{ static_asset(getArrayValue('image_72x72_url', $icon))}}" alt=""
                                    ...
                                    <div class="col-lg-12 text-right btn-margin mt-3 mb-4">
