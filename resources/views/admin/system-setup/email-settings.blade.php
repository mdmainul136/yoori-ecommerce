...
|| (old('mail_driver') =='mailjet'? '' : (((old('mail_driver') =='' && $mail_driver =='mailjet')  || ($mail_driver == '' && old('mail_driver') =='')) ? '' : 'd-none' )))
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="email" name="smtp_mail_address"
                                               ...
                                               value="{{ old('smtp_mail_address') ? old('smtp_mail_address') : (config('app.demo_mode') ? emailAddressMask(settingHelper('smtp_mail_address')) : env('MAIL_FROM_ADDRESS'))}}"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="smtp_mail_username"
                                               ...
                                               value="{{ old('smtp_mail_username') ? old('smtp_mail_username') : (config('app.demo_mode') ? Str::of(settingHelper('smtp_mail_username'))->mask('*', 0, strlen(settingHelper('smtp_mail_username'))-3) : env('MAIL_USERNAME')) }}"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="password" name="smtp_mail_password"
                                               ...
                                               value="{{ old('smtp_mail_password') ? old('smtp_mail_password') : (config('app.demo_mode') ? "********" : env('MAIL_PASSWORD')) }}"
