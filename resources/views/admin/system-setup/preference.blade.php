                                    ...
                                    <form action="{{ route('admin.preference.setting.update') }}" method="post">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    ...
                                                    @if (settingHelper('maintenance_mode') == 1)
                                                        <div class="invalid-feedback">
                                                            Access
                                                            here:
                                                            {{ route('home') . '/' . settingHelper('maintenance_secret') }}
                                                        </div>
                                                    @endif
                                                </td>
                                                <td width="300">
                                                ...
                                                <td width="300">
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            ...
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('seller_system') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
                                                ...
                                                <td width="300">
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            ...
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('seller_product_auto_approve') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
                                                ...
                                                <td width="300">
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            ...
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('wallet_system') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
                                                ...
                                                <td width="300">
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            ...
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('coupon_system') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
                                                ...
                                                <td width="300">
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            ...
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('pickup_point') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
                                                ...
                                                <td width="300">
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            ...
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('pay_later_system') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            ...
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('stock_out_product_hide') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    @if (!settingHelper('live_api_currency'))
                                                        <label class="custom-switch mt-2 modal-menu" data-toggle="modal"
                                                            title="{{ __('Exchange Rate') }}"
                                                            data-original_title="{{ __('Exchange Rate') }}"
                                                            data-url="{{ route('edit-info', ['page_name' => 'live-currency']) }}"
                                                            data-target="#common-modal">
                                                            <input type="checkbox" name="custom-switch-checkbox"
                                                                class="custom-switch-input"
                                                                {{ settingHelper('live_api_currency') == 1 ? 'checked' : '' }} />
                                                            <span class="custom-switch-indicator"></span>
                                                        </label>
                                                    @else
                                                        <label class="custom-switch mt-2">
                                                ...
                                                <td width="300">
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            ...
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('disable_email_confirmation') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
                                                ...
                                                <td width="300">
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            ...
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('disable_guest_checkout') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th colspan="2">{{ __('product_sold') }}</th>
                                            </tr>
                                            <tr>
                                                <td>{{ __('Product_sold_activation') }}</td>
                                                <td>
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                            value="setting-status-change/{{ 'sold' }}"
                                                            class="custom-switch-input status-change"
                                                            {{ settingHelper('sold') == 1 ? 'checked' : '' }} />
                                                        <span class="custom-switch-indicator"></span>
                                                    </label>
                                                </td>
                                            </tr>
