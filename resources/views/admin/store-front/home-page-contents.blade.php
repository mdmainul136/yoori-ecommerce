            ...
            <div class="card-body mobile_banner banner-{{ $content_count }}">
                <div class="alert alert-light alert-has-icon p-0">
                    ...
                    <div class="alert-body">
                        ...
                        @endphp
                        <div class="form-text">Recommended 650X300</div>
                    </div>
                </div>
                <input type="hidden" name="content_numbers[]" class="content_numbers" value="{{ $content_count }}">
                <input type="hidden" name="contents[]" class="section_name" value="banner">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                                ...
                                                                <div class="custom-file">
                                                                    ...
                                                                    <select class="form-control selectric action_type"
                                                                        ...
                                                                        <option value="product"
                                                                            {{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'product' ? 'selected' : '' }}>
                                                                            {{ __('Product') }}</option>
                                                                        <option value="category"
                                                                            {{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'category' ? 'selected' : '' }}>
                                                                            {{ __('Category') }}</option>
                                                                        <option value="brand"
                                                                            {{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'brand' ? 'selected' : '' }}>
                                                                            {{ __('Brand') }}</option>
                                                                        @if (settingHelper('seller_system') == 1 && Route::currentRouteName() != 'seller.mobile.home.page')
                                                                            <option value="seller"
                                                                                {{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'seller' ? 'selected' : '' }}>
                                                                                {{ __('Seller') }}</option>
                                                                        @endif
                                                                        <option value="blog"
                                                                            {{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'blog' ? 'selected' : '' }}>
                                                                            {{ __('Blog') }}</option>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="productDiv" id="product_{{ $content_count }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select
                                                                        class="product-by-ajax_{{ $content_count }} form-control select2"
                                                            ...
                                                            {{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'category' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label>{{ __('Action To') }}</label>
                                                                    <select
                                                                        class="filter-categories-by-ajax_{{ $content_count }} form-control"
                                                            ...
                                                            <div class="blogDiv" id="blog_{{ $content_count }}"
                                                                style="
                                                            {{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'blog' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label>{{ __('Action To') }}</label>
                                                                    <select
                                                                        class="filter-blogs-by-ajax_{{ $content_count }} form-control"
                                                                        name="blog_id_{{ $content_count }}[{{ $key }}]"
                                                                        aria-hidden="true" id="blog_id">
                                                                        @if (arrayCheck('action_to', $banner_contetns) && arrayCheck($key, $banner_contetns['action_to'][$key]))
                                                                            @php
                                                                                $blog = \App\Models\Blog::find(
                                                                                    $banner_contetns['action_to'][$key][
                                                                                        $key
                                                                                    ],
                                                                                );
                                                            ...
                                                            <div class="brandDiv" id="brand_{{ $content_count }}"
                                                                style="{{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'brand' ? '' : 'display:none' }}">
                                                                <div class="form-group">
                                                                    <label>{{ __('Action To') }}</label>
                                                                    <select class="form-control selectric"
                                                                        ...
                                                                        @foreach ($brands as $brand)
                                                                            <option value="{{ $brand->id }}"
                                                                                {{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'brand' && $brand->id == $banner_contetns['action_to'][$key][$key] ? 'selected' : '' }}>
                                                            ...
                                                            @if (settingHelper('seller_system') == 1)
                                                                <div class="sellerDiv"
                                                                    id="seller_{{ $content_count }}"
                                                                    style="{{ arrayCheck('action_type', $banner_contetns) && arrayCheck($key, $banner_contetns['action_type']) && $banner_contetns['action_type'][$key] == 'seller' ? '' : 'display:none' }}">
                                                                    <div class="form-group">
                                                                        <label>{{ __('Action To') }}</label>
                                                                        <select
                                                                            class="seller-by-ajax_{{ $content_count }} form-control select2"
                                                                            name="sl_{{ $content_count }}[{{ $key }}]"
                                                                            aria-hidden="true">
                                                                            @if (arrayCheck('action_to', $banner_contetns) && arrayCheck($key, $banner_contetns['action_to'][$key]))
                                                                                @php
                                                                                    $seller = \App\Models\SellerProfile::find(
                                                                                        $banner_contetns['action_to'][
                                                                                            $key
                                                                                        ][$key],
                                                                                    );
                                                                                @endphp
                                                ...
                                                @else
                                                    <input type="text"
                                                        class="form-control mt-2 mr-sm-2 menu-url-input"
                ...
                @else
                    ...
                    @endphp
                    @include(
                        'admin.store-front.home-page-contents',
            ...
            <div class="row">
                <div class="col-md-6 ml-4 mb-2">
                    <a href="javaScript:void(0)"
                        class="btn btn-outline-secondary add-home-content {{ @$key >= 1 ? 'd-none' : '' }}"
                        data-type="banner-image" data-area="banner-{{ $content_count }}"
                        data-content="{{ $content_count }}" class="btn btn-outline-primary"><i
                            class="bx bx-plus"></i> {{ __('Add New') }}</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <select class="form-control selectric action_type"
                                                    ...
                                                    @if (settingHelper('seller_system') == 1 &&
                                                            Route::currentRouteName() != 'seller.mobile.home.page' &&
                                                            Route::currentRouteName() != 'seller.get.shop.content')
                                    ...
                                    <div class="col-lg-6">
                                        <div class="productDiv" id="product_{{ $content_count }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select
                                                    class="product-by-ajax_{{ $for_content }} form-control select2"
                                                    id="product_id_{{ $content_count }}"
                                        ...
                                        <div class="categoryDiv" id="category_{{ $content_count }}"
                                            style="{{ old('action_type')
                                                ? (old('action_type') == 'category'
                                                    ? ''
                                                    : 'display:none')
                                                : (isset($edit)
                                                    ? ($edit->action_type == 'category'
                                                        ? ''
                                                        : 'display:none')
                                                    : 'display:none') }}">
                                            <div class="form-group">
                                                <label>{{ __('Action To') }}</label>
                                                <select
                                                    class="filter-categories-by-ajax_{{ $for_content }} form-control select2"
                                        ...
                                        <div class="blogDiv" id="blog_{{ $content_count }}"
                                            style="{{ old('action_type')
                                                ? (old('action_type') == 'blog'
                                                    ? ''
                                                    : 'display:none')
                                                : (isset($edit)
                                                    ? ($edit->action_type == 'blog'
                                                        ? ''
                                                        : 'display:none')
                                                    : 'display:none') }}">
                                            <div class="form-group">
                                                <label>{{ __('Action To') }}</label>
                                                <select
                                                    class="filter-blogs-by-ajax_{{ $for_content }} form-control select2"
                                                    name="blog_id_{{ $for_content }}[]" aria-hidden="true"
                                                    id="blog_id">
                                        ...
                                        <div class="brandDiv" id="brand_{{ $content_count }}"
                                            style="{{ old('action_type')
                                                ? (old('action_type') == 'brand'
                                                    ? ''
                                                    : 'display:none')
                                                : (isset($edit)
                                                    ? ($edit->action_type == 'brand'
                                                        ? ''
                                                        : 'display:none')
                                                    : 'display:none') }}">
                                            <div class="form-group">
                                        ...
                                        @if (settingHelper('seller_system') == 1)
                                            <div class="sellerDiv" id="seller_{{ $content_count }}"
                                                style="{{ old('action_type')
                                                    ? (old('action_type') == 'seller'
                                                        ? ''
                                                        : 'display:none')
                                                    : (isset($edit)
                                                        ? ($edit->action_type == 'seller'
                                                            ? ''
                                                            : 'display:none')
                                                        : 'display:none') }}">
                                                <div class="form-group">
                                                    <label>{{ __('Action To') }}</label>
                                                    <select
                                                        class="seller-by-ajax_{{ $for_content }} form-control select2"
                                                        name="sl_{{ $for_content }}[]" aria-hidden="true">
                                                        <option selected value=""> {{ __('seller') }}
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            @else
                                <input type="text" class="form-control mt-2 mr-sm-2 menu-url-input" id="link"
                                    name="banner_url_{{ $for_content }}[]" value="{{ '/' }}"
                                    placeholder="{{ __('Link/Slug') }}">
                            @endif
                        </div>
                    </div>
    ...
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                ...
                <input type="hidden" name="contents[]" class="section_name" value="campaign">
                <select class="form-control select2" name="campaign_{{ $content_count }}[]" required multiple>
                    ...
                    @foreach ($campaigns as $campaign)
                        <option value="{{ $campaign->id }}"
                            {{ @$contents ? (in_array($campaign->id, $contents['campaign']) ? 'selected' : '') : '' }}>
                            {{ $campaign->getTranslation('title', \App::getLocale()) }}</option>
                    @endforeach
                </select>
            </div>
        </div>
...
@elseif($type == 'popular_category')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                <input type="hidden" name="contents[]" class="section_name" value="popular_category">
                <select
                    class="form-control filter-categories-by-ajax filter-categories-by-ajax_{{ $content_count }} lang"
                    name="popular_category_{{ $content_count }}[]" multiple required>
                    <option value="">{{ __('Select Category') }}</option>
                    @if (@arrayCheck('popular_category', $contents))
                        @php
                            $categories = \App\Models\Category::whereIn('id', $contents['popular_category'])->get();
                        @endphp
...
@elseif($type == 'top_category')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                <input type="hidden" name="contents[]" class="section_name" value="top_category">
                <select
                    class="form-control filter-categories-by-ajax filter-categories-by-ajax_{{ $content_count }} lang"
                    name="top_category_{{ $content_count }}[]" multiple required>
                    <option value="">{{ __('Select Category') }}</option>
                    @if (@arrayCheck('top_category', $contents))
                        @php
                            $categories = \App\Models\Category::where('parent_id',null)->whereIn('id', $contents['top_category'])->get();
                        @endphp
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}" selected>
                                {{ $category->getTranslation('title', app()->getLocale()) }}</option>
...
@elseif($type == 'latest_product')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
            <input type="hidden" name="contents[]" class="section_name" value="latest_product">
...
@elseif($type == 'flash_deal')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
            <input type="hidden" name="contents[]" class="section_name" value="flash_deal">
...
@elseif($type == 'all_products')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
            <input type="hidden" name="contents[]" class="section_name" value="all_products">
            <input type="hidden" name="all_products_{{ $content_count }}[]" value="{{ $content_count }}">
        </div>
    </div>
@elseif($type == 'best_selling_products')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
            <input type="hidden" name="contents[]" class="section_name" value="best_selling_products">
            <input type="hidden" name="best_selling_products_{{ $content_count }}[]"
                value="{{ $content_count }}">
        </div>
    </div>

    {{-- marquee section --}}
@elseif($type == 'marquee_section')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            <div class="card-header d-flex justify-content-between border-0">
                <a href="javaScript:void(0)" class="d-flex"><i class="bx bx-menu move"></i>
            ...
            <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
            <input type="hidden" name="contents[]" class="section_name" value="marquee_section">
            <input type="hidden" name="marquee_section_{{ $content_count }}[]" value="{{ $content_count }}">
        </div>
    </div>
@elseif($type == 'category_section')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                <input type="hidden" name="contents[]" class="section_name" value="category_section">
                <input type="hidden" name="category_section_{{ $content_count }}[]"
                    value="{{ $content_count }}">
                <div class="form-group">
                    <select
                        class="form-control filter-categories-by-ajax filter-categories-by-ajax_{{ $content_count }} lang"
                        name="category_section_{{ $content_count }}_category" required>
                        <option value="">{{ __('Select Category') }}</option>
                        @if (@arrayCheck('category_section', $contents))
                            @php
                                $categories = \App\Models\Category::whereIn('id', $contents['category_section'])->get();
                            @endphp
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}" selected>
                                    {{ $category->getTranslation('title', app()->getLocale()) }}</option>
                                ...
                                <div class="row">
                                                ...
                                                @php
                                                    ...
                                                    if (isset($contents)):
                                                        $thumb = \App\Models\Media::find(
                                                            $contents['category_section']['banner'],
                                                        );
                                                    endif;
                                                @endphp
                                                @if ($thumb)
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                                            data-selection="single" data-target="#galleryModal" data-dismiss="modal">
                                            <input type="hidden"
                                                name="category_section_{{ $content_count }}_banner" id="banner"
                                                class="image-selected"
...
@include('admin.store-front.offer_end')
...
@elseif($type == 'popular_brands')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
            <input type="hidden" name="contents[]" class="section_name" value="popular_brands">
    ...
    @if (settingHelper('seller_system') == 1)
        <div class="drag-brop-menu content-{{ $content_count }}">
            <div class="menu-item card" data-id="{{ $content_count }}">
                ...
                <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                <input type="hidden" name="contents[]" class="section_name" value="top_sellers">
    ...
    @if (settingHelper('seller_system') == 1)
        <div class="drag-brop-menu content-{{ $content_count }}">
            <div class="menu-item card" data-id="{{ $content_count }}">
                ...
                <div class="card-body campaign-{{ $content_count }}">
                    <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                    <input type="hidden" name="contents[]" class="section_name" value="featured_sellers">
                    <div class="limit-2-custom-message">
                        <select class="select2" style="width: 100%;" name="featured_sellers_{{ $content_count }}[]"
                            multiple required>
                            @php
                                $sellers = \App\Models\User::with('sellerProfile')
                            ...
                            @foreach ($sellers as $seller)
                                <option value="{{ $seller->id }}"
                                    {{ @$contents ? (in_array($seller->id, $contents['featured_sellers']) ? 'selected' : '') : '' }}>
    ...
    @if (settingHelper('seller_system') == 1)
        <div class="drag-brop-menu content-{{ $content_count }}">
            <div class="menu-item card" data-id="{{ $content_count }}">
                ...
                <div class="card-body campaign-{{ $content_count }}">
                    <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                    <input type="hidden" name="contents[]" class="section_name" value="express_sellers">
                    <div class="limit-4-custom-message">
                        <select class="select2" style="width: 100%;" name="express_sellers_{{ $content_count }}[]"
                            ...
                            @foreach ($sellers as $seller)
                                <option value="{{ $seller->id }}"
                                    {{ @$contents ? (in_array($seller->id, $contents['express_sellers']) ? 'selected' : '') : '' }}>
                                    {{ @$seller->sellerProfile->shop_name . ' (' . $seller->first_name . ' ' . $seller->last_name . ')' }}
                                </option>
                            @endforeach
                        </select>
    ...
    @if (settingHelper('seller_system') == 1)
        <div class="drag-brop-menu content-{{ $content_count }}">
            <div class="menu-item card" data-id="{{ $content_count }}">
                ...
                <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                <input type="hidden" name="contents[]" class="section_name" value="best_sellers">
    ...
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <div class="card-body download_section-{{ $content_count }}">
                <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                <input type="hidden" name="contents[]" class="section_name" value="download_section">
                <input type="hidden" name="download_section_{{ $content_count }}[]"
                    value="{{ $content_count }}">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="download_section_{{ $content_count }}_text" id="text"
                            required value="{{ @$contents ? $contents['download_section']['text'] : '' }}"
    ...
    @if (addon_is_activated('video_shopping'))
        <div class="drag-brop-menu content-{{ $content_count }}">
            <div class="menu-item card" data-id="{{ $content_count }}">
                ...
                <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                <input type="hidden" name="contents[]" class="section_name" value="video_shopping">
...
@elseif($type == 'custom_products')
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{ $content_count }}">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                <input type="hidden" name="content_numbers[]" value="{{ $content_count }}">
                <input type="hidden" name="contents[]" class="section_name" value="custom_products">
                <select class="product-by-ajax form-control select2" id="custom_products_{{ $content_count }}"
                    multiple name="custom_products_{{ $content_count }}[]" aria-hidden="true">
