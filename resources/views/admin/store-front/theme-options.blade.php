                    ...
                    <div class="tab-content no-padding" id="myTab2Content">
                        <div class="tab-pane fade show active" id="themeoption" role="tabpane1"
                            ...
                            <div class="card">
                                ...
                                <div class="col-md-12 middle card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="fonts" name="fonts" class="form-control selectric">
                                                ...
                                                <option value="Figtree"
                                                        @if(old('fonts') ? old('fonts') : settingHelper('fonts') == 'Figtree') selected @endif> Figtree</option>

                                                <option value="Outfit"
                                                        @if(old('fonts') ? old('fonts') : settingHelper('fonts') == 'Outfit') selected @endif> Outfit</option>
