                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="sg-builder-content text-center builder-content">
                                    ...
                                    <div class="card builder add-home-content" data-type="all_products"
                                         data-area="home-content">
                                        <div class="card-overlay">
                                            <a href="#"><i class="eicon-menu-toggle"></i></a>
                                        </div>
                                        <div class="icon">
                                            <i class="eicon-menu-toggle"></i>
                                        </div>
                                        <p class="title">{{ __("all_products") }}</p>
                                    </div>
                                    ...
                                    <div class="card builder add-home-content" data-type="offer_ending_soon"
                                        ...
                                        <p class="title">{{ __("today_special") }}</p>
                                    </div>
                                    ...
                                    <div class="card builder add-home-content" data-type="marquee_section"
                                         data-area="home-content">
                                        <div class="card-overlay">
                                            <a href="#"><i class="eicon-plus"></i></a>
                                        </div>
