                                ...
                                <div class="card-body col-md-12 middle">
                                    <form method="post" action="{{route('admin.banners.update')}}" enctype="multipart/form-data">
                                        ...
                                        @method('put')
                                            ...
                                            <label for="logo">{{ __('Login Banner') }} 652X677</label>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="logo">{{ __('SingUp Banner') }} 652X677</label>
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                                     data-target="#galleryModal" data-dismiss="modal">
                                        ...
                                        @if(settingHelper('seller_system') == 1)
                                            <div class="form-group">
                                            <label for="logo">{{ __('Seller SingUp Banner') }} 652X852</label>
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                                     data-target="#galleryModal" data-dismiss="modal">
                                        ...
                                        @endif
                                        <div class="form-group">
                                            <label for="logo">{{ __('Forgot Password Banner') }} 652X677</label>
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                                     data-target="#galleryModal" data-dismiss="modal">
                                        ...
                                        <div class="form-group">
                                            <label for="logo">{{ __('User Dashboard Banner') }} 1320X105</label>
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                                     data-target="#galleryModal" data-dismiss="modal">
                                        ...
                                        <div class="form-group">
                                            <label for="logo">{{ __('Default Category Banner') }} 970X270</label>
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                                     data-target="#galleryModal" data-dismiss="modal">
