        ...
        <div class="d-flex justify-content-between">
            ...
            @if (hasPermission('slider_create'))
                <div class="buttons add-button">
                    ...
                    @php
                    $count = addon_is_activated('ishopet') ? 2 : 2;
                    @endphp
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-md">
                                ...
                                <tr id="row_{{ $slider->id }}" class="table-data-row">
                                    ...
                                    <td>{{ $slider->order }}</td>
                                    <td><img src="{{ getFileLink('72x72',$slider->bg_image) }}" alt="{{ @$slider->title }}" class="mr-3 rounded" width="72"></td>
                                    <td>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-striped table-md">
                                ...
                                @foreach($banners->take(2) as $key => $banner)
