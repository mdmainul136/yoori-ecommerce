                            ...
                            <form action="{{ $route }}" method="post"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <input type="text" name="title" id="title" value="{{ old('title') ? old('title') : @$post->title }}" class="form-control">
                                        ...
                                        <select class="form-control selectric" name="status" id="status">
                                            ...
                                            <option value="published"
                                                @if(old('status') == 'published')
                                                    selected
                                                @elseif(isset($post) && $post->blog->status == 'published')
                                                    selected
                                                @endif>
                                                {{ __('Publish') }}
                                            </option>
                                            ...
                                            <option value="draft"
                                                @if(old('status') == 'draft')
                                                    selected
                                                @elseif(isset($post) && $post->blog->status == 'draft')
                                                    selected
                                                @endif>
                                                {{ __('Draft') }}
                                            </option>
                                            ...
                                            <option value="pending"
                                                @if(old('status') == 'pending')
                                                    selected
                                                @elseif(isset($post) && $post->blog->status == 'pending')
                                                    selected
                                                @endif>
                                                {{ __('Pending') }}
                                            </option>
                                ...
                                <div class="form-group row mb-4">
                                    <label for="logo" class="col-form-label text-md-right col-12 col-md-3 col-lg-3" for="image">{{ __('Thumbnail') }} (385X260)</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    <label for="logo" class="col-form-label text-md-right col-12 col-md-3 col-lg-3" for="image">{{ __('Banner') }}(853X446)</label>
                                    <div class="col-sm-12 col-md-7">
                                        <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                             data-target="#galleryModal" data-dismiss="modal">
