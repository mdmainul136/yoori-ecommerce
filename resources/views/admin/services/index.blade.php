                            ...
                            <table class="table table-striped table-md">
                                ...
                                <tr id="row_{{ $service->id }}" class="table-data-row">
                                    ...
                                    <td>
                                        ...
                                        {{-- <img src="{{ getFileLink('72x72',@$service->image['images']) }}" alt="{{ $service->id }}" width="72"> --}}
                                        <img src="{{ getImageWithSvgFallback('72x72', @$service->image['images']) }}" alt="{{ $service->id }}" width="72">
