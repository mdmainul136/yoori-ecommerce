...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('api_content/css/materialdesignicons.min.css') }}?version=130">
    <link rel="stylesheet" href="{{ static_asset('admin/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ static_asset('api_content/css/main.css') }}?{{ date('YmdHis') }}">
    <link rel="stylesheet" href="{{ static_asset('api_content/css/development.css') }}">
    <link rel="stylesheet" href="{{ static_asset('api_content/css/responsive.css') }}">
    <link rel="stylesheet" href="{{ static_asset('admin/css/toastr.min.css') }}">
    <link rel="stylesheet" href="{{ static_asset('api_content/css/vue-toastr-2.min.css') }}">
                            ...
                            @if(settingHelper('is_paypal_activated') == 1)
                                <li>
                                    <div class="input-checkbox">
                                        ...
                                        <label for="paypal">
                                            <img src="{{ url('images/payment-method/paypal.svg') }}" alt="paypal"
                                                 class="img-fluid">
                                            {{ __('pay_with_payPal') }}
                                        </label>
                                    </div>
                            ...
                            @if(settingHelper('is_amarpay_activated') == 1)
                                <li>
                                    <div class="input-checkbox">
                                        ...
                                        <label for="paypal">
                                            <img src="{{ url('images/payment-method/paypal.svg') }}"
                                                 alt="paypal"
                                                 class="img-fluid">
                                            {{ __('pay_with_payPal') }}
                                        </label>
                                ...
                                <li>
                                    <div class="input-checkbox">
                                        <input type="radio" id="stripe" value="stripe"
                                               name="payment">
                                        <label for="stripe">
                                            <img src="{{ url('images/payment-method/stripe.svg') }}" alt="stripe"
                                                 class="img-fluid">
                                            {{ __('pay_with_stripe') }}
                                        </label>
                                    </div>
                                ...
                                <li>
                                    <div class="input-checkbox">
                                        ...
                                        <label for="ssl_commerze">
                                            <img src="{{ url('images/payment-method/sslcommerze.svg') }}"
                                                 alt="ssl_commerze"
                                                 width="90">
                                ...
                                <li>
                                    <div class="input-checkbox">
                                        <input type="radio" id="paytm" value="paytm"
                                               name="payment">
                                        <label for="paytm">
                                            <img src="{{ url('images/payment-method/paytm.svg') }}" alt="paytm"
                                                 class="img-fluid">
                                            {{ __('pay_with_paytm') }}
                                        </label>
                                    </div>
                            ...
                            @if(settingHelper('is_razorpay_activated') == 1)
                                <li>
                                    <div class="input-checkbox">
                                        ...
                                        <label for="razor_pay">
                                            <img src="{{ url('images/payment-method/razorpay.svg') }}"
                                                 alt="razor_pay"
                                                 width="90"
                                                 class="img-fluid">
                                ...
                                <li>
                                    <div class="input-checkbox">
                                        <input type="radio" id="jazzCash" value="jazz_cash"
                                               name="payment">
                                        <label for="jazzCash">
                                            <img src="{{ url('images/payment-method/jazzCash.svg') }}"
                                                 alt="jazzCash"
                                                 width="90"
                                                 class="img-fluid">
                                ...
                                <li>
                                    <div class="input-checkbox">
                                        <input type="radio" id="mollie" value="mollie"
                                               name="payment">
                                        <label for="mollie">
                                            <img src="{{ url('images/payment-method/mollie.svg') }}"
                                                 alt="mollie"
                                                 width="90"
                                                 class="img-fluid">
                                            {{ __('pay_with_mollie') }}
                                ...
                                <li>
                                    <div class="input-checkbox">
                                        <input type="radio" id="paystack" value="paystack"
                                               name="payment">
                                        <label for="paystack">
                                            <img src="{{ url('images/payment-method/paystack.svg') }}"
                                                 alt="paystack"
                                                 width="90"
                                                 class="img-fluid">
                                ...
                                <li>
                                    <div class="input-checkbox">
                                        ...
                                        <label for="flutter_wave">
                                            <img src="{{ url('images/payment-method/fw.svg') }}"
                                                 alt="flutter_wave"
                                                 width="90"
                                                 class="img-fluid">
                                            {{ __('pay_with_flutter') }}
                            ...
                            @if(settingHelper('is_amarpay_activated') == 1)
                                <li>
                                    <div class="input-checkbox">
                                        ...
                                        <label for="amarpay">
                                            <img src="{{ url('images/payment-method/amarpay.svg') }}"
                                                 alt="paypal"
                                                 class="img-fluid">
                                            {{ __('pay_with_amarpay') }}
                                        </label>
                            ...
                            @if(settingHelper('is_skrill_activated') == 1)
                                <li>
                                    <div class="input-checkbox">
                                        ...
                                        <label for="skrill">
                                            <img src="{{ url('images/payment-method/skrill.svg') }}"
                                                 alt="paypal"
                                                 class="img-fluid">
                                            {{ __('pay_with_amarpay') }}
                                        </label>
                            ...
                            @if(settingHelper('is_iyzico_activated') == 1)
                                <li>
                                    <div class="input-checkbox">
                                        ...
                                        <label for="iyzico">
                                            <img src="{{ url('images/payment-method/iyzico.svg') }}"
                                                 alt="paypal"
                                                 class="img-fluid">
                                            {{ __('pay_with_amarpay') }}
                                        </label>
                                ...
                                @if(settingHelper('is_hitpay_activated') == 1)
                                    <li>
                                        <div class="input-checkbox">
                                            ...
                                            <label for="hitpay">
                                                <img src="{{ url('images/payment-method/hitpay.svg') }}"
                                                    alt="paypal"
                                                    class="img-fluid">
                                                {{ __('pay_with_hitpay') }}
                                            </label>
                                ...
                                <li>
                                    <div class="input-checkbox">
                                        <input type="radio" id="kkiapay" value="kkiapay"
                                               name="payment">
                                        <label for="kkiapay">
                                            <img src="{{ url('images/payment-method/kkiapay.svg') }}"
                                                 alt="kkiapay"
                            ...
                            @if(settingHelper('pay_later_system') == 1 && authUser())
                                <li>
                                    <div class="input-checkbox">
                                        ...
                                        <label for="pay_later">
                                            <img src="{{ url('images/payment-method/paylater.svg') }}"
                                                 alt="pay_later"
...
<script src="{{ static_asset('api_content/js/vue-toastr-2.js') }}"></script>
...
@if(settingHelper('is_kkiapay_activated') == 1)
    <script amount="{{ round($orders->sum('total_payable') * $xof->exchange_rate) }}"
            ...
            src="{{ asset('public/api_content/js/k.js') }}"></script>
@endif
...
@if(settingHelper('is_paypal_activated') == 1)
    ...
    <script src="{{ static_asset('api_content/js/paypal.js') }}"></script>
@endif
...
@if(settingHelper('is_razorpay_activated') == 1)
    <script>
        ...
        myScript.setAttribute('src', '{{ static_asset('api_content/js/razor_pay_checkout.js') }}');
