...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('api_content/css/main.css') }}">
                ...
                <div class="sg-shipping">
                    <div class="card-list">
                        <ul class="global-list grid-3">
                            ...
                            @endif
                            @if(settingHelper('is_razorpay_activated') == 1 && $currency == "INR")
                                <li>
                                    <div class="input-checkbox">
...
@endif
    ...
    @if(settingHelper('is_razorpay_activated') == 1 && $currency == 'INR')
        <script>
            ...
            myScript.setAttribute('data-amount', {{ round($amount * 100) }});
