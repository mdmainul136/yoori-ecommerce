                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        ...
                        @if(!isset($is_catalog))
                            @if(!isset($is_classified))
                                <li class="nav-item">
                                    <a class="nav-link bar {{ old('sms_method') == 'nexmo_sms' ? 'active' : '' }} {{ has_key(['shipping_type','shipping_fee','shipping_fee_depend_on_quantity','cash_on_delivery','is_digital','estimated_shipping_days','product_file'],$errors) ? 'error' : '' }} }}"
                        ...
                        @if(addon_is_activated('refund') || isset($is_catalog))
                            <li class="nav-item">
                                <a class="nav-link bar {{ old('sms_method') == 'ssl_wireless' ? 'active' : '' }} {{ has_key(['campaign','campaign_discount','campaign_discount_type','is_refundable','is_featured','todays_deal','external_link'],$errors) ? 'error' : '' }}"
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link bar {{ old('sms_method') == 'mimo_sms' ? 'active' : '' }} {{ has_key(['meta_title','meta_description','meta_image','meta_keywords'],$errors) ? 'error' : '' }}"
                                            ...
                                            <div class="drag-brop-menu" id="drag-brop-menu">
                                                @if(old('wholesaleprice'))
                                                    @foreach(old('wholesaleprice') as $key => $wholesale)
                                                        ...
                                                        <div class="menu-item" data-id="1">
                                                            ...
                                                            <input type="number"
                                                                   class="form-control mb-2 mr-sm-2 wholesale_min_qty"
                                                                   data-id="1" name="min_qty[]"
                                                                   value="{{ @$old_min_qty }}" min="0"
                                                                   placeholder="{{__('Minimum QTY')}}">
                                                            <input type="number"
                                                                   class="form-control mb-2 mr-sm-2 wholesale_max_qty"
                                                                   data-id="1" name="max_qty[]"
                                                                   value="{{ @$old_max_qty }}" min="0"
                                                                   placeholder="{{__('Maximum QTY')}}">
                                                            <input type="number"
                                                                   class="form-control mb-2 mr-sm-2 wholesale_min_price"
                                                                   id="link" name="wholesaleprice[]"
                                                                   value="{{ @$price }}" min="0" step="any"
                                                                   placeholder="{{__('Price per piece')}}">
                                                            @if($key > 0)
                                                                <button type="button"
                                                ...
                                                @else
                                                    <div class="menu-item" data-id="1">
                                                        ...
                                                        <input type="number"
                                                               class="form-control mb-2 mr-sm-2 wholesale_min_qty"
                                                               data-id="1" name="min_qty[]" value="1" readonly min="0"
                                                               placeholder="{{__('Minimum QTY')}}">
                                                        <input type="number"
                                                               class="form-control mb-2 mr-sm-2 wholesale_max_qty"
                                                               data-id="1" name="max_qty[]" min="0"
                                                               placeholder="{{__('Maximum QTY')}}">
                                                        <input type="number"
                                                               class="form-control mb-2 mr-sm-2 wholesale_min_price"
                                                               id="link" name="wholesaleprice[]" value="{{ @$price }}"
                                                               min="0" step="any"
                                                               placeholder="{{__('Price per piece')}}">
                                                    </div>
                                                @endif
                                        ...
                                        @if(settingHelper('shipping_fee_type') == 'product_base')
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <select class="form-control selectric shipping-type"
                                                    ...
                                                    <option
                                                            value="free_shipping"
                                                            {{ old('shipping_type') == 'free_shipping' ? 'selected' : '' }} selected>{{ __('Free Shipping') }}</option>
                                                </select>
